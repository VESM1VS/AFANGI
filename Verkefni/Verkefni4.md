...
1. Settu upp á brauðbretti með Arduino og stilltu servo **með kóða** í upphafstöðu (90 gráður), kóðinn á að vera í `setup()`. Leiðréttu arminn (taka af og setja aftur á), láttu hann vísa fram (90 gráður). [Leiðbeiningar og kóði](https://lastminuteengineers.com/servo-motor-arduino-tutorial/).
