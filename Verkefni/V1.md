...
#### Verkefnið 
1. Settu upp rás með aflgjafa (5V), 220 ohm viðnám og rautt LED (eins og rásina sem þú settir upp í lið 1). 
1. Ef spennufall (e. Forward Voltage) á rauðri LED (mv. 20mA straum.) er 1.8V skv skv. [LED datasheet](https://learn.adafruit.com/all-about-leds/the-led-datasheet) hvert er spennufallið hjá viðnáminu?
