...
1. Láttu Servo með kóða færir sig í þrjár stöður; fyrst í 0 gráður svo 180 gráður og að lokum í 90 gráður (ekki endurtekning). Ath það getur verið að gráður í kóðanum stemmi ekki alveg við raunveruleikann, gerið lagfæringar í kóðanum.
